...
function Navbar() {
  ...
  return (
    <div className="w-full max-w-7xl">
      <div
        className={`w-full max-w-7xl mx-auto p-4 md:p-6 dark:bg-black/80 dark:text-white ${
          isScrolling
            ? "fixed top-0 z-50 shadow-lg bg-backgroundPrimary/90"
            : " p-4 md:block md:pr-0"
        } ${isOpen ? "h-dvh md:h-auto bg-white/90" : ""}`}
      >
        <nav className="container relative flex flex-wrap items-center justify-between mx-auto lg:justify-between xl:px-0">
          <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
            ...
            {/* Mobile Nav */}
            <div
              className={`flex flex-wrap w-full my-12 gap-4 lg:hidden ${
                isOpen ? "block" : "hidden"
              }`}
